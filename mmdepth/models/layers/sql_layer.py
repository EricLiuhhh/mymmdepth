...
class SQLLayer(nn.Module):
    def __init__(self, in_channels, embedding_dim=128, patch_size=16, num_heads=4, query_nums=100, dim_out=256,
        ...
        self.positional_encodings = nn.Parameter(torch.rand(500, embedding_dim), requires_grad=True) # Parameter containing: Parameter[500, 32]
    ...
    def forward(self, x0):
        ...
        self_cost_volume, summary_embedding = self.self_query(x0, queries)
