...
class SQLDepth(BaseEstimator):
    def __init__(self, 
        ...
        self.img_decoder.build_conv_outs(conv_out_locations, **conv_out_cfg)
        self.sql_layer = MODELS.build(sql_layer)
    ...
    def _forward(self, batch_inputs, batch_data_samples=None):
        ...
        img_decoder_outputs = list(img_decoder_outputs.values())
        pred = self.sql_layer(img_decoder_outputs[-1])
        return pred, (pose1, pose2)
