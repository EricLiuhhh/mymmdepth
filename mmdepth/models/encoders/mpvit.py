...
class DWCPatchEmbed(nn.Module):
    ...
    def __init__(
        ...
        self.patch_conv = nn.Sequential(
            ConvModule(in_chans, embed_dim, patch_size, stride, (patch_size-1)//2, groups=embed_dim, bias=False, act_cfg=None),
            ConvModule(in_chans, embed_dim, 1, 1, 0, act_cfg=act_cfg, norm_cfg=norm_cfg),
        )
...
class ResBlock(nn.Module):
    def __init__(
        ...
        self.conv1 = ConvModule(
            in_features, hidden_features, 1, act_cfg=act_cfg, norm_cfg=norm_cfg
        )
        ...
        self.conv2 = ConvModule(hidden_features, out_features, 1, norm_cfg=norm_cfg, act_cfg=None)
