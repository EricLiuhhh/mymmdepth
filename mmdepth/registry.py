...
"""mmdepthection provides 17 registry nodes to support using modules across
...
RUNNERS = Registry(
    'runner', parent=MMENGINE_RUNNERS, locations=['mmdepth.engine.runner'])
# # manage runner constructors that define how to initialize runners
# RUNNER_CONSTRUCTORS = Registry(
#     'runner constructor',
#     parent=MMENGINE_RUNNER_CONSTRUCTORS,
#     locations=['mmdepth.engine.runner'])
# # manage all kinds of loops like `EpochBasedTrainLoop`
# LOOPS = Registry(
#     'loop', parent=MMENGINE_LOOPS, locations=['mmdepth.engine.runner'])
...
#     locations=['mmdepth.datasets.samplers'])
TRANSFORMS = Registry(
    'transform',
...
LOG_PROCESSORS = Registry(
    ...
    # TODO: update the location when mmdepth has its own log processor
    locations=['mmdepth.engine'])
